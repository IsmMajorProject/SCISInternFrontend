...
function CreateListing() {
  ...
  const createListing = () => {
    let url = `${apiUrl.backend}/api/listing`;
    let config = {
      headers: {
  ...
  return (
    <>
      ...
      <div className="CreateListing">
        <div className="CreateListing-side">
        <div style={{ marginLeft: "19%", width: "100%" , marginTop:'75%' }}>
              <img
                width="60%"
        ...
        <div className="CreateListing-header">
          <Typography variant="h1" style={{fontFamily:'monospace'}}>Create Listing</Typography>
        </div>
